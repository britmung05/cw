    ...
    <div class="formulario">
        <form action="./dynamics/php/crearPublicación.php" method="post">
            <fieldset>
                ...
                <textarea name="descripcion" id="textDescrip" cols="30" rows="3" placeholder="Ingresa tu texto" required></textarea>
                ...
                <div class="cont-btns-form">
                    <button id="send" class="btns" type="submit">Enviar</button>
